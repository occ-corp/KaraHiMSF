...
Employee Scorng Sheet(ESS) is an help application for 
...
To help the evaluation, this application provides 
following features.
...
* show the results and summaries of the evaluation
...
ESS depends on following packages,
