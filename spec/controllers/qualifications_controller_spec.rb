...
describe QualificationsController do
  ...
  def mock_qualification(stubs={})
    @mock_qualification ||= mock_model(Qualification, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all qualifications as @qualifications" do
      Qualification.stub(:all) { [mock_qualification] }
      get :index
      assigns(:qualifications).should eq([mock_qualification])
    end
  end

  describe "GET show" do
    it "assigns the requested qualification as @qualification" do
      Qualification.stub(:find).with("37") { mock_qualification }
      get :show, :id => "37"
      assigns(:qualification).should be(mock_qualification)
    end
  end

  describe "GET new" do
    it "assigns a new qualification as @qualification" do
      Qualification.stub(:new) { mock_qualification }
      get :new
      assigns(:qualification).should be(mock_qualification)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created qualification as @qualification" do
        Qualification.stub(:new).with({'these' => 'params'}) { mock_qualification(:save => true) }
        post :create, :qualification => {'these' => 'params'}
        assigns(:qualification).should be(mock_qualification)
      end

      it "redirects to the created qualification" do
        Qualification.stub(:new) { mock_qualification(:save => true) }
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved qualification as @qualification" do
        Qualification.stub(:new).with({'these' => 'params'}) { mock_qualification(:save => false) }
        post :create, :qualification => {'these' => 'params'}
        assigns(:qualification).should be(mock_qualification)
      end

      it "re-renders the 'new' template" do
        Qualification.stub(:new) { mock_qualification(:save => false) }
        post :create, :qualification => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested qualification" do
        Qualification.should_receive(:find).with("37") { mock_qualification }
        mock_qualification.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => "37", :qualification => {'these' => 'params'}
      end

      it "assigns the requested qualification as @qualification" do
        Qualification.stub(:find) { mock_qualification(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:qualification).should be(mock_qualification)
      end
    ...
    describe "with invalid params" do
      it "assigns the qualification as @qualification" do
        Qualification.stub(:find) { mock_qualification(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:qualification).should be(mock_qualification)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the qualifications list" do
      Qualification.stub(:find) { mock_qualification }
      delete :destroy, :id => "1"
